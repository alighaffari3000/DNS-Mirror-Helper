...
* **حالت نت ملی (MELLI)** — تست خودکار فهرست DNSهای داخلی و انتخاب سریع‌ترین DNS در دسترس (بدون هیچ وابستگی خارجی — گزینهٔ درست در زمان قطعی اینترنت بین‌الملل)
...
**در زمان قطعی اینترنت بین‌الملل**، حالت DoH (نت آزاد) نمی‌تواند به resolverهای بالادست خود برسد؛ پس از **حالت MELLI** استفاده کنید — این حالت `resolv.conf` را به فهرستی از DNSهای داخلی ست می‌کند و به هیچ دانلود خارجی نیاز ندارد.
